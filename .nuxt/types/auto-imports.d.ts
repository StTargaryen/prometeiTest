...
declare global {
  ...
  const useGqlHeaders: typeof import('../../node_modules/nuxt-graphql-client/dist/runtime/composables')['useGqlHeaders']
  const useGqlToken: typeof import('../../node_modules/nuxt-graphql-client/dist/runtime/composables')['useGqlToken']
  const useGqlCors: typeof import('../../node_modules/nuxt-graphql-client/dist/runtime/composables')['useGqlCors']
  const useGql: typeof import('../../node_modules/nuxt-graphql-client/dist/runtime/composables')['useGql']
  const deepmerge: typeof import('../../node_modules/nuxt-graphql-client/dist/runtime/utils')['deepmerge']
  const gqlSdk: typeof import('#build/gql-sdk')['getSdk']
  const GqlCatalogMenu: typeof import('#build/gql')['GqlCatalogMenu']
  const GqlProductByArticle: typeof import('#build/gql')['GqlProductByArticle']
  const GqlProductCardDataBySlug: typeof import('#build/gql')['GqlProductCardDataBySlug']
  const GqlProductsBySubcategorySlug: typeof import('#build/gql')['GqlProductsBySubcategorySlug']
  const GqlSubcategoryDataBySlug: typeof import('#build/gql')['GqlSubcategoryDataBySlug']
  const GqlGetCategoryBySlug: typeof import('#build/gql')['GqlGetCategoryBySlug']
  const GqlGetRootCategories: typeof import('#build/gql')['GqlGetRootCategories']
